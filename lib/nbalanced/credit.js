 ...
 * @param {Number|Object} amount The amount to credit. USD cents. You must have amount funds transferred to cover the credit.
 * @param {String|Function} [description] The description of the credit transaction, optional.
 * @param {Number} data.amount The amount to credit. USD cents. You must have amount funds transferred to cover the credit.
 * @param {String} [data.description] The description of the credit transaction, optional.
 * @param {String} [data.appears_on_statement_as] The text that will appear on the merchant's bank statement, optional.
 * @param {Function} [callback] The callback method to call upon completion or error.
 */
credit.prototype.add = function (credits_uri, amount, description, callback) {
    var self = this, data;
