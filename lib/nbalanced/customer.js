...
/**
 * Get cards saved to a customer.
 *
 * @param {String} [customer_uri] The account URI originally passed back from Balanced after creating the customer.
 * @param {Function} [callback] The callback method to call upon completion or error.
 */
customer.prototype.getCards = function(customer_uri, callback) {
    var self = this;
