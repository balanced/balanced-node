 ...
 * @param {Function} [callback] The callback method to call upon completion or error.
 */
bankAccount.prototype.delete = function (item_uri, callback) {
    var self = this;
    if (!validate.parameterRequired(item_uri, "item_uri", callback)) return;

    // Will get something like this /v1/marketplaces/:marketplace_id/bank_accounts/:bank_account_id
    // Need to make it something like this /v1/bank_accounts/:bank_account_id
    var hackyDeleteUri = item_uri.replace(self._marketplace_uri, "/v1");
